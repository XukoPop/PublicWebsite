            ...
            <div>
              ...
              >
                <p className="text-zinc-300">
                  • Discord: <span className="text-white">zryh</span>
                </p>
              </motion.div>
            </div>

            <div>
              <h2 className="text-xl font-semibold mb-4">Zryh currently doing:</h2>
              <motion.div 
                whileHover={{ scale: 1.02 }}
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <motion.p 
                ...
                transition={{ duration: 0.2 }}
              >
                • <a href="https://steamcommunity.com/id/xukox/" 
              ...
              <motion.p 
                ...
                transition={{ duration: 0.2 }}
              >
                • <a href="https://steamcommunity.com/id/xukoview/" 
                    className="text-white hover:underline">Steam Profile (Alt)</a>
              </motion.p>
            </div>
          </div>
